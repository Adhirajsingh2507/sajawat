...
- **Remaining Phase 1:** **1.10b** launch readiness — **1.10b.1 performance/load (k6+Lighthouse), 1.10b.2 coverage ratchet, and 1.10b.3 observability/alerting are DONE**; only **1.10b.4 backups & disaster recovery** remains → **`v1.0.0`** production release. (1.9 hardening + 1.10a E2E journeys are also done.)
