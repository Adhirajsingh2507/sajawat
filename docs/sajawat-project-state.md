...
- **Remaining Phase 1:** **1.10b+** launch readiness — performance/load tests, coverage ratchet, observability/alerting, backups → **`v1.0.0`** production release. (1.9 hardening + 1.10a E2E journeys are **done**.)
